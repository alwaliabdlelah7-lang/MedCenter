          ...
          <form onSubmit={handleSubmit} className="space-y-6 text-right">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button 
                ...
                disabled={loading}
                className="w-full py-4 bg-white text-slate-900 rounded-[25px] font-black shadow-xl hover:bg-slate-100 active:scale-95 transition-all text-xs flex items-center justify-center gap-2"
              >
              ...
              <button 
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    setError('فشل تسجيل الدخول عبر Auth0');
                  } finally {
                    setLoading(false);
                  }
                }}
                disabled={loading}
                className="w-full py-4 bg-slate-100 text-slate-900 rounded-[25px] font-black shadow-xl hover:bg-slate-200 active:scale-95 transition-all text-xs flex items-center justify-center gap-2"
              >
                <div className="w-4 h-4 flex-shrink-0 flex items-center justify-center">
                  <img src="https://cdn.auth0.com/website/press/resources/auth0-logo-monochrome.svg" className="w-full h-full" alt="Auth0" />
                </div>
                Auth0
              </button>
            </div>
